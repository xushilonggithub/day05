...
<body class="gray-bg">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveEmp.htm">
						...
						<tr>
								<td>学生性别：</td>
								<td><input type="radio" id="sSex1" name="sSex"
						...
						<tr>
								<td>学生爱好：</td>
								<td><input type="checkbox" id="sHobby1" name="sHobby"
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" action="importStudent.htm" enctype="multipart/form-date">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>请选择导入文件：</td>
